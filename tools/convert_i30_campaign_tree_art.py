...
def main() -> None:
    ...
    insp = [
        ...
        "sp_ct_insp_ottomanism_s1",
        "sp_ct_insp_ottomanism_s2",
        "sp_ct_insp_ottomanism_s3",
        "sp_ct_insp_ottomanism_s4",
        "sp_ct_insp_constitutional_ottoman",
        "sp_ct_insp_islamism",
        "sp_ct_insp_islamism_s1",
        "sp_ct_insp_islamism_s2",
        "sp_ct_insp_islamism_s3",
        "sp_ct_insp_islamism_s4",
        "sp_ct_insp_great_caliphate",
        "sp_ct_insp_turkism",
        "sp_ct_insp_turan",
        "sp_ct_insp_turan_s1",
        "sp_ct_insp_turan_s2",
