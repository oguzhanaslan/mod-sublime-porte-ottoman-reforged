...
- **R-26 / I-24 — Tanzimat interactive reform buttons:** audit [`docs/research/TANZIMAT_INTERACTIVE_REFORMS_AUDIT.md`](docs/research/TANZIMAT_INTERACTIVE_REFORMS_AUDIT.md); dossier [`docs/implementation/TANZIMAT_INTERACTIVE_REFORMS.md`](docs/implementation/TANZIMAT_INTERACTIVE_REFORMS.md). Gates of the Bosphorus companion-JE button idea used as mechanical inspiration only (upstream license null; no copied code/assets). Additive `sp_je_tanzimat_reforms` with four one-shot decrees (Cizye, Çiftlik, Maarif, Esir Pazarı). No custom amendments, no `je_sick_man_main` REPLACE, no Tanzimat point, no elifba copy. **R-24 not reused.** Gameplay `ff6bf9ce0718ddef332f5f0413a322116907be57`; docs `04bda20c4f0f08fa232416147db68b87f32cdffb`. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.**
...
- **I-08 — Ottoman Balkan cohesion:** [`docs/research/I08_balkan_cohesion_gameplay_proposal.md`](docs/research/I08_balkan_cohesion_gameplay_proposal.md), [`docs/implementation/I08_balkan_cohesion.md`](docs/implementation/I08_balkan_cohesion.md). One non-progress guidance JE, one introductory event, Police/Home Affairs clarity, the verified seven-culture GEC-01 activation predicate and GEC-04 movement-gate filter were implemented in `64ca4e9`. Global war, growing-secession convenience triggers and crushed-secession attribution remain deliberately deferred. **2026-08-26 flavor follow-up:** [`docs/research/I08_rumelian_instruments_flavor.md`](docs/research/I08_rumelian_instruments_flavor.md) — `sp_balkan_cohesion.1` applies `sp_i08_rumelian_instruments` (Intelligentsia +1 / Landowners +1, 365 days); no secession/turmoil/fervor gift. **IMPLEMENTED — STATIC/TIGER REVIEW COMPLETE; 1836 GUIDANCE PASS; OPENING-EVENT FLAVOR STATIC VALIDATED / RUNTIME PENDING.**
...
- **R-23 — Imperial Periphery:** [`docs/research/R23_imperial_periphery.md`](docs/research/R23_imperial_periphery.md). User-supplied three-theatre contract (Trablusgarp / Tunis / Arabia–Red Sea) audited against vanilla 1.13.11. Vanilla already splits sovereignty: `c:TRI` TUR **puppet** with Ottoman governor Mahmud Raif (1835 restoration abstraction) + Fezzan starting war + unincorporated Cyrenaica; `c:TUN` TUR **protectorate** (Husaynid Mustafa/Ahmad; cannot annex until LD &lt; 25 then decrease autonomy); Hedjaz `c:HDJ` is **EGY tributary** (I-07); Nejd/Jabal Shammar independent (JAB in Ottoman power bloc + pro-TUR lobby); Yemen split among Azal/Lahej/Mahra/Kathiri/Hedjaz with **Aden as Lahej city hub**, not British; al-Hasa is a Nejd farm hub; **no Senussi** tag/religion/JE (closest native: decentralized `c:ZWY` Zuwayya). **Tripoli YES** (1 informational event; no map rewrite). **Tunisia YES** (2 events; keep protectorate). **Arabia NO.** **Yemen YES** (Aden alarm only). **Al-Hasa NO.** **Senussi NO.** **Umbrella JE NO.** **Subject rewrite NO.** Approx **4** events. **COMPLETE — USED IN I-23.**

- **I-23 — Imperial Periphery:** proposal [`docs/research/I23_imperial_periphery_proposal.md`](docs/research/I23_imperial_periphery_proposal.md); dossier [`docs/implementation/I23_imperial_periphery.md`](docs/implementation/I23_imperial_periphery.md). Four additive TUR events (`sp_i23.1` Tripoli acknowledgement + 365-day IG flavor `sp_i23_coastal_authority`; `sp_i23.2` Tunis press LD +10 / relations −10 vs accommodate relations +10 no LD; `sp_i23.3` French pressure DLC-off gate, back down FRA +10 / TUN +5 vs maintain FRA −10 / TUN LD +10; `sp_i23.4` Aden MODEL B NO EFFECT). No JE, no subject rewrite. Gameplay `c72cffe`. Flavor follow-up [`docs/research/I23_tripoli_flavor.md`](docs/research/I23_tripoli_flavor.md). **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.**

- **R-24 — Imperial capital and symbolic territorial events:** **DROPPED / OUT OF SCOPE.** Not planned development. War- or treaty-dependent capital/Straits reenactment (İstanbul threatened/lost/recovered, Straits Question JE, 1841/1856/1871/1877–78 capital crisis, Cyprus Convention, capital relocation) is not queued. No proposal, no I-ID, no implementation. Do not reuse the ID. I-16 Hünkâr İskelesi / 1841 lapse is unchanged.

## Everyday Flavor

- **R-27 — Ottoman everyday flavor pack:** [`docs/research/R27_ottoman_everyday_flavor.md`](docs/research/R27_ottoman_everyday_flavor.md). Vanilla 1.13.11 + current-mod pulse/overlap audit for 1836–1876 quiet-period flavor (bureaucracy, schools, telegraph, press, advisers, rail, petitions, ports, streets, translation). 13 candidates audited; Steam on the Bosphorus SKIP (I-14 Hayriye); civil servants MERGE; Karantina COULD. **R-24 not reused.** **COMPLETE — USED IN I-25.**
- **I-25 — Ottoman everyday flavor pack:** proposal [`docs/research/I25_ottoman_everyday_flavor_proposal.md`](docs/research/I25_ottoman_everyday_flavor_proposal.md); implementation [`docs/implementation/I25_ottoman_everyday_flavor.md`](docs/implementation/I25_ottoman_everyday_flavor.md). Ten one-shot TUR events (`sp_i25.1`–`.10`); 0 JE; 0 new systems; 18-month cooldown + at-most-one yearly dispatch. `.5` relations effect removed by user approval. Gameplay `5715e28676ff6d5ab0a61235cbd053d3637cc4cb`. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.**

## Music & Audio

- **R-28 — Victoria 3 music system:** [`docs/research/R28_victoria3_music_system.md`](docs/research/R28_victoria3_music_system.md). Vanilla 1.13.11 FMOD mood/main-theme/stinger audit: script contract, pause/density, OST lengths, additive mod paths (`file:/` community vs FMOD banks). **COMPLETE — USED IN I-26.**
- **I-26 — Ottoman mood music (five tracks):** dossier [`docs/implementation/I26_ottoman_mood_music.md`](docs/implementation/I26_ottoman_mood_music.md). Five additive TUR-gated mood tracks; Music Player category `sp_mx_category_ottoman`; EN/TR loc. User-approved 2026-08-26. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** (RT-I26-01–05).

## Imperial Palaces / Monuments

- **R-29 — Ottoman Imperial Palaces architecture audit:** [`docs/research/R29_ottoman_imperial_palaces.md`](docs/research/R29_ottoman_imperial_palaces.md). Gates architecture inspiration only; vanilla 1.13.11 monument audit. **COMPLETE — USED IN I-27.**
- **I-27 — Ottoman Imperial Palaces:** proposal [`docs/research/I27_ottoman_imperial_palaces_proposal.md`](docs/research/I27_ottoman_imperial_palaces_proposal.md); dossier [`docs/implementation/I27_ottoman_imperial_palaces.md`](docs/implementation/I27_ottoman_imperial_palaces.md). Topkapı Complex + Dolmabahçe constructible monument; Tanzimat gate = `je_sick_man_main` OR `sp_i18_has_domestic_tanzimat_reform`; transfer + museum decisions; ownership/monarchy safety. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.**
...
- **Campaign Tree UI — research / technical proposal only:** [`docs/research/SUBLIME_PORTE_CAMPAIGN_TREE_UI_PROPOSAL.md`](docs/research/SUBLIME_PORTE_CAMPAIGN_TREE_UI_PROPOSAL.md). CMF 1.13 sidebar (`custom_button_list_flag` / `com_open_window` / optional `com_fullscreen`) + additive scripted_widgets; maps real shipped JE/flag/variable arcs (~41 presentation nodes); read-only node states; detail inspector; verified JE open/pin when active. Screen title locked to **Sublime Porte: Ottoman Reforged**. **COMPLETE — RESEARCH ONLY; APPROVED FOR PHASE 1–2.**
- **I-30 — Campaign Tree UI Phase 1–3:** [`docs/implementation/I30_campaign_tree_ui.md`](docs/implementation/I30_campaign_tree_ui.md). Sidebar + near-fullscreen window + Tanzimat→Identity→Turan slice + detail inspector (live requirements/progress, Open JE/Pin); Phase 5 artwork backlog recorded; no new DDS. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.** Native tooltip pass (2026-08-27): ExecuteTooltip territory/req rows, JE GetCompletionTooltip strips, event `show_as_tooltip` claim previews; JE complete/immediate timing unchanged. **RUNTIME-VERIFICATION REQUIRED.**
- **Victoria 3 UI Library — project documentation mirror:** [`docs/development/VIC3_UI_LIBRARY.md`](docs/development/VIC3_UI_LIBRARY.md). Extracted from installed vanilla `1.13.11` `game/gui/window_component_library.gui` (in-game debug catalog: Buttons, Backgrounds, Headers, Frames, Dividers, etc.). No standalone Paradox wiki page exists; UI Art Guide / UX Guide tabs are Paradox-internal stubs. Regenerate via `tools/extract_ui_library_catalog.py` after game patches. Linked from [`PARADOX_GUI_GUIDE.md`](docs/development/PARADOX_GUI_GUIDE.md) §10.1. **COMPLETE — DOCUMENTATION ONLY.**
...
- **Phase 5 release-facing polish:** [`docs/implementation/P5_v1_release_polish.md`](docs/implementation/P5_v1_release_polish.md). **COMPLETE 2026-08-25** in loc `b5315e9` and docs/metadata `08c800a`. Player-facing EN/TR text, `1.0.0` / `1.13.*` metadata, README, and changelog. Tiger `fatal 0 / error 1 / warning 10`. Gameplay unchanged. DNA/artwork/Workshop images remain optional. **I-18 IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** ([`docs/implementation/I18_post_tanzimat_political_development.md`](docs/implementation/I18_post_tanzimat_political_development.md)). **I-21 IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** ([`docs/implementation/I21_kurdish_provincial_centralization.md`](docs/implementation/I21_kurdish_provincial_centralization.md)). **Journal Presentation Pass Phase 1 IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** ([`docs/implementation/JOURNAL_PRESENTATION_PASS_PHASE1.md`](docs/implementation/JOURNAL_PRESENTATION_PASS_PHASE1.md)). **I-22 IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** ([`docs/implementation/I22_armenian_question.md`](docs/implementation/I22_armenian_question.md)). **Journal Presentation Pass Phase 2 (Armenian Question JE) IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** via I-22. Canonical next work: **I-27 runtime checklist (RT-I27-01–09)**; parallel **I-25 runtime checklist (RT-I25-01–12)**; I-24 / I-23 / I-22 / Phase 1 / I-21 / I-18 / I-16 runtime checklists remain pending; **I-27 is IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** ([`docs/implementation/I27_ottoman_imperial_palaces.md`](docs/implementation/I27_ottoman_imperial_palaces.md)); **R-29 is COMPLETE — USED IN I-27**; **R-27 is COMPLETE — USED IN I-25** ([`docs/research/R27_ottoman_everyday_flavor.md`](docs/research/R27_ottoman_everyday_flavor.md)); **I-25 is IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING** ([`docs/implementation/I25_ottoman_everyday_flavor.md`](docs/implementation/I25_ottoman_everyday_flavor.md)); **R-24 is DROPPED / OUT OF SCOPE** (not reused); **R-26 is COMPLETE — USED IN I-24**; **I-24 is IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING**; Community localization contributor support is **I-17**.
