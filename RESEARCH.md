...
- **I-14 — Ottoman company/institution flavor:** proposal [`docs/research/I14_ottoman_company_institution_proposal.md`](docs/research/I14_ottoman_company_institution_proposal.md); implementation [`docs/implementation/I14_ottoman_company_institution_flavor.md`](docs/implementation/I14_ottoman_company_institution_flavor.md). Hayriye company + Ottoman Bank one-shot event. Gameplay `77397d57901284b68dcce37769fa470a7d851a08`; docs `109d43e514a0a1b4e3caf98204588a37c3b0539e`. **IMPLEMENTED; TIGER CLEAN FOR I-14; DATE-GATED RUNTIME REMAINS IN I-15.** Do not expand (no Düyun / Memleket companies).

## Validation & Release

- **I-15 — v1.0 release validation matrix:** [`docs/research/I15_release_validation_matrix.md`](docs/research/I15_release_validation_matrix.md). Single test matrix for I-01–I-14. **STARTED.** Static execution `6767622` (2026-08-25): 16 PASS / 0 FAIL / 95 runtime NOT RUN; Tiger `fatal 0 / error 1 / warning 10`. First 1836 visual session: no confirmed runtime bug. `sp_balkan_cohesion.1` informational/effect-free behavior **PASS** (intentional). I-15 gameplay/fix pass **not started** (no reproduced bug). Canonical next work: remaining I-15 runtime → reproduced BLOCKER/HIGH fixes only → Phase 5 Visual/Polish → final release validation → v1.0. R-20–R-24 remain Future v1.x.
