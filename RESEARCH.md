...
- **I-12 — Muhacir migration slice gameplay proposal:** [`docs/research/I12_muhacir_gameplay_proposal.md`](docs/research/I12_muhacir_gameplay_proposal.md). Converts R-14 into an implementation contract: Wave A 100k Tatar (Crimea 40% move + 70k paid `create_pop`), Wave B 250k combined Circassian target with mutually exclusive vanilla-management vs conservation modes, Wave C conservation-only compound crisis trigger, timed commission JEs, and additive file list. **PROPOSAL WRITTEN — GAMEPLAY IMPLEMENTATION NOT APPROVED.**
