...
- **R-29 — Ottoman Imperial Palaces architecture audit:** [`docs/research/R29_ottoman_imperial_palaces.md`](docs/research/R29_ottoman_imperial_palaces.md). Gates of the Bosphorus Topkapı/Dolmabahçe pattern audited as architecture inspiration only (no code/asset/number copy; upstream license null). Vanilla 1.13.11 canonical refs: Hagia Sophia start monument, Forbidden City/White House admin-like PMs, `construction_cost_monument = 2500`, buildable monument `possible` gates, `on_state_owner_change`. Current mod has no custom buildings/PMs/decisions. **R-24 not reused.** Upgrade **NO**; JE **NO**; ownership safety **YES**. **COMPLETE — RESEARCH ONLY; USED IN I-27 PROPOSAL.**
- **I-27 — Ottoman Imperial Palaces proposal:** [`docs/research/I27_ottoman_imperial_palaces_proposal.md`](docs/research/I27_ottoman_imperial_palaces_proposal.md). Topkapı 1836 Active unique monument; Dolmabahçe government-constructible (soft floor 1843 + Sick Man JE + romanticism); court-transfer decision; museum via `realism` (not `civilizing_mission`); independent modest balance; vanilla icon placeholders; Phase 5 Topkapı/Dolmabahçe art **HIGH**. **PROPOSAL ONLY — AWAITING APPROVAL; GAMEPLAY DIFF 0.**
