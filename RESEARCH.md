...
- **R-11 — Character/Commander Dossier:** [`docs/research/R11_character_commander_dossier.md`](docs/research/R11_character_commander_dossier.md). Vanilla 1.13.11 inventory, I-10A roster, exact vanilla trait audit, I-10B event feasibility and duplicate risks are complete. I-10A v1 is implemented in `c91e515`. The documentation-only [`I-10B gameplay proposal`](docs/research/I10B_iconic_officers_gameplay_proposal.md) recommends the three mandatory officers—Fevzi 1850, Mustafa Kemal 1852 and Kâzım Karabekir 1857—as additive one-shot events with generated appearance, and defers Cemal plus custom DNA to a later Visual Pass. Enver is **VANILLA / VotP CONTENT — DO NOT REIMPLEMENT, RETIME OR DUPLICATE**. **R-11 COMPLETE; I-10A IMPLEMENTED; I-10B PROPOSAL COMPLETE, EXPLICIT IMPLEMENTATION APPROVAL PENDING.**
