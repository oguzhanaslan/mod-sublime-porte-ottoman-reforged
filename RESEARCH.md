...
- **I-30 — Campaign Tree UI Phase 1+2:** [`docs/implementation/I30_campaign_tree_ui.md`](docs/implementation/I30_campaign_tree_ui.md). Sidebar + near-fullscreen window + Tanzimat→Identity→Turan interactive slice; read-only states; selection var only. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.**
