...
- **R-21 — Kurdish provincial autonomy and centralization:** [`docs/research/R21_kurdish_provincial_autonomy_centralization.md`](docs/research/R21_kurdish_provincial_autonomy_centralization.md). User-supplied 1836–47 contract audited against vanilla 1.13.11 and current mod overlap (I-01, I-05, I-06, I-08, I-09, I-11, I-18). Frame is **centralization vs emirates/local notables**, not Kurdish nationalism. Vanilla supplies `cu:kurdish`, eastern homelands, `ig_local_governors`, Sick Man/Tanzimat laws, Police/Home Affairs, radicals/turmoil, and `movement_cultural_minority` secession (late-game). **Rejected:** custom autonomy meter, `c:KUR` subject/spawn, forced 1836 rebellion, Bedirhan character, second centralization JE, I-01 pop edits. **Recommended:** four one-shot events (`sp_r21.1`–`.4`), event-only Bedirhan, 1847 direct-administration acknowledgement. Primary states: `STATE_DIYARBAKIR`, `STATE_MOSUL`; secondary `STATE_ERZURUM`. **COMPLETE — RESEARCH ONLY; PROPOSAL-READY; NOT IMPLEMENTED.**
