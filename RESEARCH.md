...
- **R-11 — Character/Commander Dossier:** [`docs/research/R11_character_commander_dossier.md`](docs/research/R11_character_commander_dossier.md). I-10A is implemented in `c91e515`. The approved three-officer [`I-10B gameplay proposal`](docs/research/I10B_iconic_officers_gameplay_proposal.md) is implemented in `a85a34c` and documented in [`docs/implementation/I10B_iconic_officers.md`](docs/implementation/I10B_iconic_officers.md): Fevzi 1850, Mustafa Kemal 1852 and Kâzım Karabekir 1857 use additive one-shot events and generated appearance; I-10B Tiger findings are 0/0/0 and runtime testing is pending. Cemal and custom DNA remain deferred. Enver is **VANILLA / VotP CONTENT — DO NOT REIMPLEMENT, RETIME OR DUPLICATE**. **R-11 COMPLETE; I-10A AND I-10B IMPLEMENTED; I-10B RUNTIME TEST PENDING.**
