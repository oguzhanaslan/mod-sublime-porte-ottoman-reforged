...
- **I-23 — Imperial Periphery:** proposal [`docs/research/I23_imperial_periphery_proposal.md`](docs/research/I23_imperial_periphery_proposal.md); dossier [`docs/implementation/I23_imperial_periphery.md`](docs/implementation/I23_imperial_periphery.md). Four additive TUR events (`sp_i23.1` Tripoli NO EFFECT; `sp_i23.2` Tunis press LD +10 / relations −10 vs accommodate relations +10 no LD; `sp_i23.3` French pressure DLC-off gate, back down FRA +10 / TUN +5 vs maintain FRA −10 / TUN LD +10; `sp_i23.4` Aden MODEL B NO EFFECT). No JE, no subject rewrite. Gameplay `c72cffe`. **IMPLEMENTED — STATIC VALIDATED / RUNTIME PENDING.**
